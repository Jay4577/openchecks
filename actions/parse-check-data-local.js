 ...
 * @param   params.CLOUDANT_HOST              host:port of the cloudant database
 ...
 */
function asyncCallOcrParseAction(actionName, cloudantHost, cloudantUser, cloudantPass, database, id, attachmentName, callback) {
  console.log("Calling", actionName, "for", id);
  whisk.invoke({
    name: actionName,
    parameters: {
      CLOUDANT_HOST: cloudantHost,
